                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="container-fluid p-0">
                                            <div class="row">
                                                <div class="col-md-6"><h4><b>From: </b><?php echo $_GET["start"] ?></h4> </div>
                                                <div class="col-md-6"><h4><b>To:</b> <?php echo $_GET["end"] ?></h4> </div>
                                            </div>
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $res = $member->getMonthlyExpenseReportByMember($_GET["start"], $_GET["end"], $id);
                                                    $index = 0;
                                                    $total = 0;
